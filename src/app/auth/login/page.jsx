...
import { MdOutlineSchool, MdEmail } from "react-icons/md";
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f5f3ff] flex items-center justify-center px-4 py-8">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-purple-100 p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 hover:border-purple-400 text-gray-700 font-semibold py-3 rounded-xl transition mb-5"
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <MdEmail className="absolute left-4 top-3.5 text-purple-400 text-lg" />
                  <input
                    type="email"
                    name="user_email"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-3.5 text-gray-400 hover:text-purple-500"
                  >
